...
return(persianNumber);
 ...
 <div className="flex justify-start  overflow-x-auto  [&::-webkit-scrollbar]:w-0 py-1 bg-white mb-2" >
    ...
    hover:text-yellow-500">  پخت و پز</button>
        ...
        <p  className='text-lg text-center text-[#371303] px-5 pb-3 font-bold  '>محصولات بوش </p>
    </div>
...
.then(res => res.json())
.then((result)=> {
setData(result.filter(i=>i.brands === "bush"));
 setDatashow(result.filter(i=>i.brands === "bush"));
setIsLoading(false);
