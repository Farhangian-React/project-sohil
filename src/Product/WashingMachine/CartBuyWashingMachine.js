...
export default function CartBuyWashingMachine() {
...
toast.success("ثبت دیدگاه با موفقیت صورت گرفت") ; 
 ...
 {cartItems.map(i=>
    ...
    <p className='text-[14px] md:text-[16px] text-gray-600 py-2 pr-2'> محصولات /  ماشین لباسشویی /
      </p>
        ...
        <List
          ...
          >
            <ListItem role="none">
              ...
              <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>مدل : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.Fs}</Typography>
            
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>عمق : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.Fd}   </Typography>
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>ستاره انرژی : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.Fstar}   </Typography>
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}> سبد مواد شوینده : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.BM}   </Typography>
            </ListItem>
          </List>
            )}
        ...
        <List
          ...
          >
            <ListItem role="none">
              ...
              <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>آبگرمکن داخلی : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.IWH}</Typography>
            
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}> گزینه بخار : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.SO}   </Typography>
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}> ارتفاع : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.Fh } </Typography>
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>  </Typography>
        ...
        <List
          ...
          >
            <ListItem role="none">
              ...
              <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}> مکانیزم شستشو : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.WM}</Typography>
            
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>عرض : </Typography>
              <Typography sx={{pr:1,fontSize:{xs:'14px',md:'16px'}}}>{i.Fw}   </Typography>
            </ListItem>
            <ListItem role="none">
            <Typography sx={{fontSize:{xs:'16px',md:'20px'},fontWeight:'500'}}>  قابلیت wifi : </Typography>
