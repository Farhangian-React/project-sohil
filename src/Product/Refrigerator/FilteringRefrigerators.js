...
export default  function FilteringRefrigerators() {
...
<Accordion
      ...
      >
        <AccordionSummary  sx={{fontSize:'16px',direction:'rtl'}} 
         ...
         expandIcon={<AddIcon sx={{fontSize:'16px',ml:1}} />}> قیمت </AccordionSummary>
        <AccordionDetails >
        <FormGroup>
...
<FormControlLabel   control={<Checkbox  checked={checkedC3}   onChange={handleChangeC3} value={"مشکی"} />} label="مشکی" />
      ...
      <Accordion
        ...
        sx={{borderBottom:'1px solid black',mr:1}}
      >
        <AccordionSummary sx={{fontSize:'16px',direction:'rtl'}}  expandIcon={<AddIcon sx={{fontSize:'16px',ml:1}} />}> تعداد طبقات</AccordionSummary>
        <AccordionDetails>
   <FormGroup>
...
<FormControlLabel  control={<Checkbox checked={checkedE2}   onChange={handleChangeE2} disabled={disabledE2} value={"ندارد"} />} label="ندارد" />
      ...
      <Accordion
        ...
        sx={{borderBottom:'1px solid black',mr:1}}
      >
        <AccordionSummary sx={{fontSize:'16px',direction:'rtl'}}  expandIcon={<AddIcon sx={{fontSize:'16px',ml:1}} />}>  یخ ساز</AccordionSummary>
        <AccordionDetails>
        <FormGroup>
...
<FormControlLabel   control={<Checkbox  checked={checkedC3}   onChange={handleChangeC3} value={"مشکی"} />} label="مشکی" />
      ...
      <Accordion
        ...
        sx={{borderBottom:'1px solid black',mr:1}}
      >
       <AccordionSummary  sx={{fontSize:'20px',direction:'rtl'}}  expandIcon={<AddIcon sx={{fontSize:'18px',ml:1}} />}> تعداد طبقات</AccordionSummary>
        <AccordionDetails>
   <FormGroup>
<FormLabel sx={{my:3}}>   تعداد طبقات </FormLabel>
<FormControlLabel control={<Checkbox checked={checkedD1} value={"2"} disabled={disabledD1}  onChange={handleChangeD1} />} label="2" />
...
<FormControlLabel  control={<Checkbox checked={checkedE2}   onChange={handleChangeE2} disabled={disabledE2} value={"ندارد"} />} label="ندارد" />
      ...
      <Accordion
        ...
        sx={{borderBottom:'1px solid black',mr:1}}
      >
        <AccordionSummary  sx={{fontSize:'20px',direction:'rtl'}}  expandIcon={<AddIcon sx={{fontSize:'18px',ml:1}} />}>  یخ ساز</AccordionSummary>
        <AccordionDetails>
        <FormGroup>
        <FormControlLabel control={<Checkbox checked={checkedY1}   onChange={handleChangeY1} disabled={disabledY1} value={"دارد"}  />} label="دارد" />
        <FormControlLabel  control={<Checkbox checked={checkedY2}   onChange={handleChangeY2} disabled={disabledY2} value={"ندارد"} />} label="ندارد" />
