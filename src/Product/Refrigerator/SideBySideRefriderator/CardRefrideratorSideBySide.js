   ...
   return (
    <> 
     <Box sx={{display:"flex",flexDirection:"column",bgcolor:"#ececec"}}>
       <Box>
    <Typography variant="h6" sx={{color:"#282828",py:4, px:5,pb:1,fontWeight: 550,textAlign:"justify"}}  > یخچال‌های ساید بای ساید</Typography>
    <Typography sx={{color:"#414141",fontSize:"16px", px:5,pb:1,textAlign:"justify"}}>
      ...
      <Typography  sx={{color:"#414141",fontSize:"16px",px:5,pb:2,mb:3,textAlign:"justify"}}>ما کار را برای یافتن یخچال ساید بای ساید مناسب برای شما انجام می دهیم.
