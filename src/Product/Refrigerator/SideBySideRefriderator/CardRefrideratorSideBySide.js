...
useEffect(()=>{
  ...
  <p className='text-black py-3 text-start font-bold text-2xl' > یخچال‌های ساید بای ساید</p>
  <p className='text-justify text-md text-gray-500 font-sans'>
      ...
      <p className='text-justify text-md text-gray-500 font-sans'>ما کار را برای یافتن یخچال ساید بای ساید مناسب برای شما انجام می دهیم.
