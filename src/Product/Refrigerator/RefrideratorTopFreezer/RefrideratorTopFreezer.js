...
import CardRefrideratorTopFreezer  from './CardRefrideratorTopFreezer';
export default  function RefrideratorTopFreezer() {
...
<MenuItem className="flex items-center py-2 rounded-lg">
 ...
 to={'/allgas'}
  ...
  >
   ...
   <CardRefrideratorTopFreezer itemsPerPage={6}/>
   <SlideOffProducts/>
          <Footer/>
</>
  );
