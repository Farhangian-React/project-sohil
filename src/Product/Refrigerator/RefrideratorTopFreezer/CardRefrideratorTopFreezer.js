  ...
  return(persianNumber);
   ...
   return (
    ...
    <Typography variant="h6" sx={{color:"#282828",py:4, px:5,pb:1,fontWeight: 550,textAlign:"justify"}}  >
         ...
         <Typography sx={{color:"#414141",fontSize:"16px", px:5,pb:1,textAlign:"justify"}}>در   sohil بهترین انتخاب از یخچال های بالا را بیابید. یخچال فریزرها معمولاً مقرون به صرفه هستند، برای فضاهای کوچکتر راحت‌تر هستند و فریزر را در سطح چشم شما قرار می‌دهند.
      </Typography>
      <Typography  sx={{color:"#414141",fontSize:"16px",px:5,pb:2,mb:3,textAlign:"justify"}}>ما استرس ناشی از یافتن یخچال عالی برای شما را از بین می بریم. ما مفتخریم که یخچال‌ها را با هر قیمتی ارائه می‌کنیم تا بتوانید آنچه را که نیاز دارید را بدون شکستن بانک پیدا کنید. با انتخاب محدوده بودجه خود شروع کنید، سپس ظرفیت متناسب با نیازهای خانوار خود را با ابعاد متناسب با فضای اختصاص داده شده در آشپزخانه خود انتخاب کنید. سپس سبک مورد علاقه خود را برای تکمیل و بیشتر انتخاب کنید! هنگامی که یکی را که دوست دارید پیدا کردید، برای خرید آن را به سبد خرید خود اضافه کنید و ضمانت های خود را اضافه کنید یا با مدل های دیگر مقایسه کنید تا انتخاب کاملی داشته باشید.
      </Typography>
    </Box>
...
<Typography sx={{px:3,pt:0.5,fontSize:{xs:"24px",lg:"22px"},direction:'rtl'}}>   یخچال های فریزر بالا
</Typography>
</Box>
