  ...
  return(persianNumber);
   ...
   return (
    ...
    <Box sx={{display:"flex",flexDirection:"column",bgcolor:"#ececec"}}>
       <Box>
    <Typography variant="h6" sx={{color:"#282828",py:4, px:5,pb:1,fontWeight: 550,textAlign:"justify"}}  >    فریزر تخصصی</Typography>
...
top: "80px",
 ...
 <FilteringSpecializedFreezer/></Box>
...
<Typography sx={{px:3,pt:0.5,fontSize:{xs:"24px",lg:"22px"},direction:'rtl'}}>   فریزر تخصصی
</Typography>
</Box>
