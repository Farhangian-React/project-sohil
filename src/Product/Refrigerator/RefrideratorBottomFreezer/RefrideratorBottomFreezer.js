...
import CardRefrideratorBottomFreezer  from './CardRefrideratorBottomFreezer';
...
export default  function RefrideratorBottomFreezer() {
...
<PageTitle title=' یخچال و فریزر / فریزر پایین ' description='   یخجال و فریزر '/>
   ...
   <CardRefrideratorBottomFreezer itemsPerPage={5}/>
   <SlideOffProducts/>
          <Footer/>
</>
  );
